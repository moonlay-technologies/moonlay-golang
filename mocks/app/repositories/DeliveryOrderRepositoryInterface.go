...
// DeleteByID provides a mock function with given fields: request, sqlTransaction, ctx, resultChan
func (_m *DeliveryOrderRepositoryInterface) DeleteByID(request *models.DeliveryOrder, sqlTransaction *sql.Tx, ctx context.Context, resultChan chan *models.DeliveryOrderChan) {
	_m.Called(request, sqlTransaction, ctx, resultChan)
}

// GetByDoRefCode provides a mock function with given fields: doRefCode, countOnly, ctx, resultChan
...
// UpdateByID provides a mock function with given fields: id, deliveryOrder, jouneyRemarks, isInsertToJourney, sqlTransaction, ctx, result
func (_m *DeliveryOrderRepositoryInterface) UpdateByID(id int, deliveryOrder *models.DeliveryOrder, jouneyRemarks string, isInsertToJourney bool, sqlTransaction *sql.Tx, ctx context.Context, result chan *models.DeliveryOrderChan) {
	_m.Called(id, deliveryOrder, jouneyRemarks, isInsertToJourney, sqlTransaction, ctx, result)
}
