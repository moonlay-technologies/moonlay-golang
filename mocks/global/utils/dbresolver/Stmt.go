...
func (_m *Stmt) ExecContext(ctx context.Context, args ...interface{}) (sql.Result, error) {
	...
	var r0 sql.Result
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...interface{}) (sql.Result, error)); ok {
		return rf(ctx, args...)
	}
...
func (_m *Stmt) Query(_a0 ...interface{}) (*sql.Rows, error) {
	...
	var r0 *sql.Rows
	var r1 error
	if rf, ok := ret.Get(0).(func(...interface{}) (*sql.Rows, error)); ok {
		return rf(_a0...)
	}
...
func (_m *Stmt) QueryContext(ctx context.Context, args ...interface{}) (*sql.Rows, error) {
	...
	var r0 *sql.Rows
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...interface{}) (*sql.Rows, error)); ok {
		return rf(ctx, args...)
	}
