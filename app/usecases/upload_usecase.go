...
func (u *uploadUseCase) RetryUploadSO(soUploadHistoryId string, ctx context.Context) *model.ErrorLog {
	...
	a, _ := json.Marshal(getUploadSOHistoriesResult.SoUploadHistory)
	fmt.Println(string(a))
