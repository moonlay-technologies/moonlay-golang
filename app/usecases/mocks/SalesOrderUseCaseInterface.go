...
func (_m *SalesOrderUseCaseInterface) UpdateSODetailById(soId, soDetailId int, request *models.SalesOrderDetailUpdateByIdRequest, sqlTransaction *sql.Tx, ctx context.Context) (*models.SalesOrderDetailStoreResponse, *model.ErrorLog) {
	return nil, nil
}
