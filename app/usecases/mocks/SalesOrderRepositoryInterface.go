...
func (_m *SalesOrderRepositoryInterface) UpdateByID(id int, salesOrder *models.SalesOrder, isInsertToJourney bool, sqlTransaction *sql.Tx, ctx context.Context, result chan *models.SalesOrderChan) {
