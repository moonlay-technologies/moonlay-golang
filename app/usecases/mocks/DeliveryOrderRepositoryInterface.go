...
func (_m *DeliveryOrderRepositoryInterface) DeleteByID(request *models.DeliveryOrder, isWriteJourney bool, sqlTransaction *sql.Tx, ctx context.Context, resultChan chan *models.DeliveryOrderChan) {
