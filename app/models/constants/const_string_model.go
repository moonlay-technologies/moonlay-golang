...
const (
	...
	SO_STATUS_APPV   = "APPV" //5
	SO_STATUS_REAPPV = "REAPPV"
	SO_STATUS_RJC    = "RJC" //9
	SO_STATUS_CNCL   = "CNCL" //10
	SO_STATUS_ORDPRT = "ORDPRT" //7
	SO_STATUS_ORDCLS = "ORDCLS" //8
	SO_STATUS_CLS    = "CLS" //14
	SO_STATUS_PEND   = "PEND" //12 & 6
	SO_STATUS_OPEN   = "OPEN" //11
	SO_STATUS_SJCR   = "SJCR"
