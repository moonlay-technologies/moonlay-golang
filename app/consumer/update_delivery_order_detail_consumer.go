...
func (c *UpdateDeliveryOrderDetailConsumerHandler) ProcessMessage() {
	...
	for {
		...
		errorLog := c.DeliveryOrderOpenSearchUseCase.SyncToOpenSearchFromUpdateEvent(&deliveryOrder, dbTransaction, c.ctx)
