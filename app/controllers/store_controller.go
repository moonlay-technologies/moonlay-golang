...
func InitStoreController(salesOrderUseCase usecases.SalesOrderUseCaseInterface, deliveryOrderUseCase usecases.DeliveryOrderUseCaseInterface, db dbresolver.DB, ctx context.Context) StoreControllerInterface {
...
func (c *storeController) GetDeliveryOrders(ctx *gin.Context) {
	...
	deliveryOrders, errorLog := c.deliveryOrderUseCase.GetByStoreID(deliveryOrderRequest)
