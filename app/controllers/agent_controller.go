...
func InitAgentController(salesOrderUseCase usecases.SalesOrderUseCaseInterface, deliveryOrderUseCase usecases.DeliveryOrderUseCaseInterface, db dbresolver.DB, ctx context.Context) AgentControllerInterface {
...
func (c *agentController) GetDeliveryOrders(ctx *gin.Context) {
	...
	deliveryOrders, errorLog := c.deliveryOrderUseCase.GetByAgentID(deliveryOrderRequest)
